        ...
        Message: {
            Body: {
                Html: {
                  ...
                  Data: `<h2>CWS-CARES Secure Account Verification</h2><h1>Verification Code</h1><div>Here is your Verification Code:</div><h1>${token}</h1><div>This is a verification code, not a password.</div><div>Simply copy this code and paste it into the Account Verification input field.</div><br><br><div>Thanks for helping us verify your CWS-CARES account.</div><div>CWS-CARES</div>`
                }
            },
            Subject: {
              //template or environment variable
